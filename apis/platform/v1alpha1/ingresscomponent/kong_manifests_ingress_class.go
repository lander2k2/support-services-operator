...
// CreateIngressClassKong creates the IngressClass resource with name kong.
func CreateIngressClassKong(
	...
	return mutate.MutateIngressClassKong(resourceObj, parent, collection, reconciler, req)
}
